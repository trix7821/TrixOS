...
<img width="2559" height="1524" alt="gui" src="https://github.com/user-attachments/assets/e2ae448a-9e5a-443d-8187-2d79f4023322" />

<img width="1332" height="756" alt="Снимок экрана 2026-08-11 200003" src="https://github.com/user-attachments/assets/138870b7-4456-4118-b720-aeec77d009a3" />

<img width="2559" height="1521" alt="tweaks" src="https://github.com/user-attachments/assets/29afdaec-e22e-4f33-9d0f-7fed67ab3654" />
...
- **Tweaks** – select individual tweaks, apply or revert them. Hover for tooltips, click the eye icon to see commands.
...
2. Run **build.bat** (Windows) to compile all three versions at once. The script will automatically find PyInstaller and use **TrixOS.ico** if available.
3. Use **Inno Setup** with **TrixOS.iss** to build the installer. The installer supports component selection (GUI, CLI, Cloud).
